...
namespace AutoDealerManager.Domain.Interfaces.Repositories
{
    public interface IConcessionariaRepository : IRepository<Concessionaria>
    {
        ...
        Task<Concessionaria> ObterConcessionariaEndereco(Guid id);
        Task<bool> ConcessionariaExisteAsync(string nome);
        Task<Concessionaria> ObterPorEnderecoAsync(Endereco endereco);
    }
}
